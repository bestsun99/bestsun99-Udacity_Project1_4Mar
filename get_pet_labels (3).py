...
for idx in range(0, len(filenames), 1):
    if filenames[idx][0] != ".": #skip the file whose name starts with . pet_labels = filenames[idx]
        pet_labels = filenames[idx]
        pet_name = ""
        low_pet_image = pet_labels.lower()
    ...
    print("\nFilename=", pet_labels, "   Label=", pet_name)
    if filenames[idx] not in results_dic:
         results_dic[filenames[idx]] = [pet_name_list[idx]]
    else:
